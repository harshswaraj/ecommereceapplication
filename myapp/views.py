...
def initiate_payment(request):
    ...
    params = (
        ...
        ('CUST_ID', str("harshswaraj1491.iitr@gmail.com")),
...
def verify_otp(request):
	...
	if otp1==otp2:
		return render(request,'new_password.html',{'otp':otp1,'email':email})
	else:
		msg="Invalid OTP"
...
def new_password(request):
	...
	if np==cnp:
		...
		return render(request,'new_passwrod.html',{'email':email, 'msg':msg})		
...
def activate_status(request):
	if request.method=="POST":
		...
		recipient_list=[email,]
		send_mail(subject, message, email_from, recipient_list)
		return render(request,'activate_status_otp.html',{'otp':otp,'email':email})
	else:
...
def activate_status_verify_otp(request):
	...
	if otp1==otp2:
		...
		msg="Invalid OTP"
		return render(request,'activate_status_otp.html',{'otp':otp1,'email':email,'msg':msg})	
